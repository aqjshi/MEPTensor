...
def process_molecule(args):
    ...
    for coord in scaled_atom_coords:
        heat_component(estimated_heat_tensor, coord[0], coord[1], coord[2], 1, 0,0,0,0,0,0)
...
def main():
    ...
    index_array, inchi_array, xyz_arrays, chiral_centers_array, rotation_array = npy_preprocessor_v4_limit(args.npy_file, limit = 100)
