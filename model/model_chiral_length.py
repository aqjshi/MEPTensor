#filters entire dataset, classifies their chiral length
import pandas as pd
import numpy as np
...
# Filter the dataset to include only rows where chiral_length is between 0 and 4 inclusive
filtered_dataset = dataset[dataset['chiral_length'].isin([0, 1, 2, 3, 4])]
